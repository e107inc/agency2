...
$GALLERY_TEMPLATE['cat']['start'] = '{GALLERY_BREADCRUMB}
        ...
        <div class="row class="bg-light"" id="portfolio">
';
 //
$GALLERY_TEMPLATE['cat']['item'] = '
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link"   href="{GALLERY_CAT_URL}">
              <div class="portfolio-hover">
                <div class="portfolio-hover-content">
                  <i class="fa fa-plus fa-3x"></i>
                </div>
              </div>
              <img class="img-fluid" src="{GALLERY_CAT_THUMB=w=300&h=200&thumbsrc}" alt="{GALLERY_CAT_TITLE=title}">            
            </a>
            <div class="portfolio-caption">
              <h4>{GALLERY_CAT_TITLE}</h4>
              <p class="text-muted">{GALLERY_CAT_DESCRIPTION}</p>
            </div>
          </div>
...
$GALLERY_TEMPLATE['portfolio']['item']      = '<div class="col-md-3 col-sm-6"><img src="{GALLERY_THUMB: w=200&h=50&thumbsrc}" 
class="img-fluid d-block mx-auto" alt="{GALLERY_CAPTION=text}"></div>';
