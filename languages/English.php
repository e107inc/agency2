...
|        Last Modified: 2018/08/29 06:38:43
|
|        $Author: Yesszus $
|
+--------------------------------------------------------------------------+
*/
define("LAN_AG_THEME_00", "Close Project");                /*ok*/
define("LAN_AG_THEME_01", "Date : ");
define("LAN_AG_THEME_02", "Client : ");                       /* need to wait for next changes or be like LAN_AG_THEME_CLIENT */ 
...
define("LAN_AG_THEME_19", "Posted on: ");
define("LAN_AG_THEME_20", "By: ");
?>
